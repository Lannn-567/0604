...
if user_input := st.chat_input("請輸入提問（例如：50字以內？）"):
    ...
    with st.chat_message("assistant"):
        ...
        # 正面特徵判定 (如果是這些關鍵字，回答是)
        elif any(keyword in q for keyword in ["生物", "爬蟲", "海洋", "吃水母", "蛋", "殼", "游泳", "水裡", "水底", "潛水", "鹽腺", "肺", "綠蠵龜", "海龜", "海裡", "海底", "水裡游"]):
            reply = "是"
            
        # 常見動物判定 (如果是常見動物，回答不是，增加遊戲難度)
        elif any(keyword in q for keyword in ["陸地", "鹿", "狗", "貓", "鳥", "魚", "獅", "大象", "人", "虎", "豹", "羊", "非洲", "吃草" , "吃肉" , "鯨" ,"豚", "哺乳", "蛇", "馬", "豬", "雞", "牛", "猴" , "鼠" , "兔" ,"蜥蜴" , "熊", "龍"]):
            reply = "不是"
